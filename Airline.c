...
void printFlightPtr(void* flightPtr) {
    Flight* flight = *(Flight**)flightPtr;
    printFlight(flight);
}

void printFlightArr(Flight** const arr, int size) {
    generalArrayFunction((void*)arr, size, sizeof(Flight*), printFlightPtr);
}

void printPlanePtr(void* pPlane)
{
    printPlane((const Plane*)pPlane);
}

void printPlanesArr(Plane* arr, int size) {
    generalArrayFunction((void*)arr, size, sizeof(Plane), printPlanePtr);
}

void freeFlightArr(Flight** const flightArr, int size) {

    generalArrayFunction((void*)flightArr, size, sizeof(Flight*), freeFlightPtr);
}
